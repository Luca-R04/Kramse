USE [master]
GO
/****** Object:  Database [Kramse_Staging]    Script Date: 28-3-2023 12:18:24 ******/
...
USE [Kramse_Staging]
GO
/****** Object:  Table [dbo].[Dim_Consignor]    Script Date: 28-3-2023 12:18:24 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Dim_Container]    Script Date: 28-3-2023 12:18:24 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Dim_Item]    Script Date: 28-3-2023 12:18:24 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Dim_Port]    Script Date: 28-3-2023 12:18:24 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Dim_Ship]    Script Date: 28-3-2023 12:18:24 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Dim_Ship](
	...
	[Start_Date] [datetime] NULL,
	[End_Date] [datetime] NULL,
 CONSTRAINT [PK_Dim_Ship_1] PRIMARY KEY CLUSTERED 
(
	[Ship_Row_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [dbo].[Dim_Waiting_Time]    Script Date: 28-3-2023 12:18:24 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Dim_Waiting_Time](
	[Waiting_Row_Id] [int] IDENTITY(1,1) NOT NULL,
...
GO
/****** Object:  Table [dbo].[F_Shipment]    Script Date: 28-3-2023 12:18:24 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[F_Voyage_Port]    Script Date: 28-3-2023 12:18:24 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
