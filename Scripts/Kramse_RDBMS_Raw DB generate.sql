...
CREATE DATABASE [Kramse_RDBMS_Raw]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Kramse_RDBMS_Raw', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLDEV2019\MSSQL\DATA\Kramse_RDBMS_Raw.mdf' , SIZE = 73728KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
